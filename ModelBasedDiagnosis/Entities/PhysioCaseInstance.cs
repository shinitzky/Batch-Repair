...
namespace ModelBasedDiagnosis.PhysiotherapyDomain
{
    class PhysioCaseInstance
    {
        ...
        public List<Comp> Observation { get; set; }
        ...
        {
            if (Id > 0 && Diagnoses != null && Diagnoses.Count != 0 && Observation != null && Observation.Count != 0 && RealDiagnosis != null && RealDiagnosis.Comps.Count != 0)
                return true;
            return false;
        }
    }
